...
export BASE_BOOTSTRAP_PKGS="base base-devel nix-daemon flatpak arch-install-scripts linux-firmware amd-ucode intel-ucode sddm dkms jq btrfs-progs grub efibootmgr openssh"
