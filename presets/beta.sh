...
export UI_BOOTSTRAP="plasma plasma-nm dolphin konsole kate sddm mesa vulkan-radeon vulkan-intel nix spectacle gwenview xf86-video-amdgpu xf86-video-intel feh xorg-xinit python-pyqt5"
